...
public class ComputerManualBuilder implements IBuild {
    ...
    public Manual getResult(){
        return new Manual(processor,memoryRAM,powerSource,ssd, graphicCard, cabinet, fans, typeCompute, motherBoard);
    }
}
